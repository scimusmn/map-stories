...
if (Dakota.find().count() === 0) {
  ...
  const data = [
...

    {
      ...
      dakotaPlaceName: 'Wita Was<span class="s-dot">͘</span>te',
      nameFilename: 'nicollet-island-name.mp4',
      explainFilename: 'nicollet-island-explained.mp4',
      description: 'Wita Was<span class="s-dot">͘</span>te is Nicollet Island. And what it translates to ' +
      'is Wita is island and Was<span class="s-dot">͘</span>te is good. So it translates to "good island."',
      offsetX: 0,
      offsetY: 0,
    },
    ...
    // Fort Snelling
    {
      ...
      dakotaPlaceName: 'H<span class="h-dot">͘</span>ah<span class="h-dot">͘</span>obdote',
      nameFilename: 'fort-snelling-name.mp4',
      explainFilename: 'fort-snelling-explain.mp4',
      description: 'H<span class="h-dot">͘</span>ah<span class="h-dot">͘</span>obdote is the throat of the rapids, which is below Fort Snelling.',
      offsetX: 0,
      offsetY: 0,
    },
